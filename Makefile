...
SRC=  main.cpp Graph.cpp gen-graph.cpp fixage.cpp test-properties.cpp compute_arrays_compat.cpp compare_with_cleophee.cpp misc.cpp gzstream/gzstream.cpp
OBJ= ${SRC:.cpp=.o}
d_OBJ= ${SRC:.cpp=_d.o}
p_OBJ= ${SRC:.cpp=_p.o}
CXX	 = g++
...
CXXFLAGS = $(IMPLFLAGS) -std=c++17 -Wall -s -O3 -Wno-unused-but-set-variable -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare #-march=native #-Winline#-D_GLIBCXX_DEBUG
