...
SRC=  main.cpp Graph.cpp gen-graph.cpp test-properties.cpp compare_with_cleophee.cpp problemArray.cpp misc.cpp gzstream/gzstream.cpp #compute_arrays_compat.cpp fixage.cpp
OBJ= ${SRC:.cpp=.o}
d_OBJ= ${SRC:.cpp=_d.o}
p_OBJ= ${SRC:.cpp=_p.o}
CXX	 = g++
...
CXXFLAGS = $(IMPLFLAGS) -std=c++23 -Wall -g -O3 -Wno-unused-but-set-variable -Wno-cast-user-defined -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-alloc-size-larger-than -Wunused-variable#-march=native #-Winline#-D_GLIBCXX_DEBUG
