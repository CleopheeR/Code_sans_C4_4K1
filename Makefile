...
CXXFLAGS = $(IMPLFLAGS) -std=c++23 -Wall -g -O3 -Wno-unused-but-set-variable -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-alloc-size-larger-than -Wunused-variable#-march=native #-Winline#-D_GLIBCXX_DEBUG
